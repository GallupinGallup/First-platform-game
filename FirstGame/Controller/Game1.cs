...
namespace FirstGame
{
	...
	public class Game1 : Game
	{
		...
		protected override void LoadContent()
		{
			...
			bgLayer1.Initialize(Content, "ShooterContent/Texture/bgLayer1", GraphicsDevice.Viewport.Width, -1);
			bgLayer2.Initialize(Content, "ShooterContent/Texture/bgLayer2", GraphicsDevice.Viewport.Width, -2);
			...
			//explosionSound = Content.Load<SoundEffect>("ShooterContent/Sound/explosion");

			//// Start the music right away
			//PlayMusic(gameplayMusic);

			mainBackground = Content.Load<Texture2D>("ShooterContent/Texture/mainbackground");
		}
